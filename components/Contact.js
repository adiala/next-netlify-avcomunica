                ...
                <div className="flex-auto p-5 lg:px-10 lg:py-0">
                  ...
                  >
                    ...
                    <div className="text-center mt-6">
                      <button
                        className="bg-primary w-full h-10 p-2 hover:bg-secondary transition-all text-white text-center text-md tracking-tight font-rubik antialiased uppercase cursor-pointer"
                        type="submit"
                        style={{ transition: "all .15s ease" }}
                      >
                        Enviar
