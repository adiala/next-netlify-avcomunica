      ...
      <nav className="flex flex-wrap lg:flex-nowrap items-center p-2 z-30 container mx-auto border-b">
        ...
        >
          <div className="lg:inline-flex lg:ml-auto lg:justify-between items-start flex flex-col lg:flex-row">
            {menuItens.map((i) => (
              <Link href={i.link}>
                <a className="lg:w-auto w-full px-2 py-2 items-end justify-center uppercase tracking-tighter text-rubik antialiased text-gray-700 lg:hover:text-primary lg:cursor-pointer">
                  {i.name}
                </a>
              </Link>
            ))}
          </div>
          <div className="flex flex-row space-x-4 items-end px-2 my-auto lg:ml-10">
            ...
            {/* Início do Botão Youtube */}
          <a
            href="https://www.youtube.com/channel/UC8rLF37-RTtjLCXLytPRLCg/featured"
            target="_blank"
            rel="noreferrer"
            className="h-5"
          >
